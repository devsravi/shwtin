...
class Builder
{
    ...
    /**
     * The ID of the authenticated user who owns the URL (or null if guest).
     */
    ...
    /**
     * The name for the user default set the domain name of your url.
     */
    protected ?string $name = null;

    /**
     * The domain to be used for the desstination URL.
     */
    ...
    public function destinationUrl(string $url): self
    {
        ...
        // Automatically set a name based on the URL
    ...
    public function make(): Url
    {
        ...
        $shortURL->save();
        $this->shortUrl = $shortURL->default_short_url;
        $this->shortKey = $shortURL->url_key;
        $this->resetOptions();
    ...
    {
        if (Url::where('url_key', $this->urlKey)->exists()) {
