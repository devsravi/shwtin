...
return [
    ...
    |
    */
    'prefix' => env('SHORT_URL_PREFIX', '/go'),
    ...
    */
    ...
    |
    */
    'default_url' => env('APP_URL', 'https://shwt.in'),
    ...
    */
    ...
    | Interfaces\UserAgentDriver.
    |
    */
    'user_agent_driver' => \App\Classes\UserAgent\ParserPhpDriver::class,
    ...
    | Interfaces\UrlKeyGenerator.
    |
    */
    'url_key_generator' => \App\Classes\KeyGenerator::class,
    'ulid_key_generator' => env('SHORT_URL_KEY_GENERATOR', \App\Classes\UlidKeyGenerator::class),
];
